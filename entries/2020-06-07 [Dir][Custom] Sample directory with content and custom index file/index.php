<?php
	...
	*/
	...
	define('SECURITY_PHRASE', 'pT1iel04Q6fODc2bbMd64dQNtZ02DI');
	define('PASSWORD', '');
	define('ADMIN', FALSE);
	...
	$color_button_back = '#fafafa';
	$color_button_text = '#aaaaaa';
	$color_button_border_off = '#505050';
	$color_button_back_off = '#fafafa';
	$color_button_text_off = '#505050';
	$color_button_hover = '#000000';
	$color_button_hover_text = '#fafafa';
	$color_button_on = '#aaaaaa';
	$color_button_text_on = '#fafafa';

	$color_overlay = '#fafafa';
